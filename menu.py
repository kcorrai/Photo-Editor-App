...
class ColorFrame(ctk.CTkFrame):
    def __init__(self, parent, color_vars):
        ...
        RevertButton(self, (color_vars['grayscale'], GRAYSCALE_DEFAULT), (color_vars['brightness'], BRIGHTNESS_DEFAULT), (color_vars['vibrance'], VIBRANCE_DEFAULT), (color_vars['invert'], INVERT_DEFAULT))
...
class EffectFrame(ctk.CTkFrame):
    def __init__(self, parent, effect_vars):
        ...
        RevertButton(self, (effect_vars['effect'], EFFECT_OPTIONS[0]), (effect_vars['blur'], BLUR_DEFAULT), (effect_vars['contrast'], CONTRAST_DEFAULT))
