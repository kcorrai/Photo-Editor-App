...
class FilenamePanel(Panel):
    def __init__(self, parent, name_string, file_string):
        ...
        ctk.CTkEntry(self, textvariable=self.name_string).pack(fill='x', padx=10, pady=10)
        frame = ctk.CTkFrame(self, fg_color='transparent')
        jpg_check = ctk.CTkCheckBox(frame, text='jpg', variable=self.file_string, command=self.click('jpg'), onvalue='jpg', offvalue='png')
        png_check = ctk.CTkCheckBox(frame, text='png', variable=self.file_string, command=self.click('png'), onvalue='png', offvalue='jpg')
